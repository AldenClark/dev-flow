...
- The supported CLI enters through `skills/dev-flow/scripts/dev-flow.py`; packet-era commands and state are unsupported and must not be resurrected as 2.0 workflow requirements.
