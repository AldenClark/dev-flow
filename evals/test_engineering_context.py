...
class ReadinessTests(unittest.TestCase):
    ...
    def test_agents_discovery_preserves_global_root_nested_and_override_selection(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            instructions = ec.discover_agent_instructions(root, ["src/feature/app.py"], codex_home)
    ...
    def test_security_scanner_presence_does_not_replace_contextual_review(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            result = ec.assess_context(root, task_type="security", risks=["security"], codex_home=root / "codex", capability_registry=CAPABILITIES)
    ...
    def test_unsafe_rust_and_swift_accessibility_derive_distinct_contextual_obligations(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            rust = ec.assess_context(rust_root, task_type="routine", risks=["unsafe"], codex_home=rust_root / "codex", capability_registry=CAPABILITIES)
