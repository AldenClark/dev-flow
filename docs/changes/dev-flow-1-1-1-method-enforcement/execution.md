...
- Final evidence includes 397 strict tests, 26 focused methodology tests, 39 repository contracts, plugin/maintainer/knowledge/compile/JSON/diff checks, and a data-security doctor with zero required failures. Two release-commit artifact builds are byte-identical; the immutable remote tag remains at the release commit; the primary cache matches final main; GitHub Actions run 31855795237 passes the six Linux/macOS/Windows and Python 3.11/3.14 cells.
