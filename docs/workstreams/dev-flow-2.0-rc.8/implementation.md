...
> Status: source implementation in progress, not an RC.8 candidate or release. `governance/product-state.json` remains the authority for current product and delivery state. [Progress and audit disposition](progress.md) records what has actually run.
